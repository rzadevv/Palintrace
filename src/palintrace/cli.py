...
from palintrace.adapters import AdapterDataError, AdapterError, FileAdapter
...
from palintrace.retrieval import RetrievalObservation, RetrievalSufficiencyPolicy
from palintrace.semantics import LocalNLISemanticJudge, SemanticJudgeError
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="palintrace", description="Normalize and audit agent memory stores"
    )
