...
from palintrace.checkers import UnsupportedClaimChecker
...
from palintrace.semantics import SemanticJudge, SemanticJudgment, SemanticRelation
...
FROZEN_BENCHMARK_SHA256 = (
    "90793984a6e191cad4cd276c185dfe8a1eac814035493a101768a96051a240f1"
)
...
class HeldoutFreezeManifest(_DeterministicModel):
    ...
    def identities_and_hashes_are_valid(self) -> HeldoutFreezeManifest:
        ...
        required = {
            ...
            "src/palintrace/evaluation/identity_grounded_heldout.py",
            "tools/run_identity_grounded_heldout_v0_1.py",
            "src/palintrace/checkers/unsupported_claim.py",
            "src/palintrace/checkers/unsupported_claim_identity_grounded.py",
            "src/palintrace/semantics/identity.py",
            "src/palintrace/semantics/local_nli.py",
            "src/palintrace/semantics/composition.py",
...
def validate_frozen_repository(
    ...
    *,
    ...
    expected_files = {
        "src/palintrace/checkers/unsupported_claim.py": FROZEN_UNSUPPORTED_CLAIM_SHA256,
        "src/palintrace/semantics/identity.py": FROZEN_IDENTITY_CONTRACT_SHA256,
        "src/palintrace/semantics/local_nli.py": FROZEN_LOCAL_NLI_SHA256,
        "src/palintrace/semantics/composition.py": FROZEN_COMPOSITION_SHA256,
        "src/palintrace/checkers/unsupported_claim_identity_grounded.py": (
            FROZEN_CANDIDATE_SHA256
        ),
        "tests/fixtures/benchmark_v0.1.sha256.json": (
    ...
    from palintrace.evaluation.benchmark import load_benchmark_spec
    ...
    public_api = (repository_root / "src/palintrace/checkers/__init__.py").read_text(
        encoding="utf-8"
    )
    cli_source = (repository_root / "src/palintrace/cli.py").read_text(encoding="utf-8")
