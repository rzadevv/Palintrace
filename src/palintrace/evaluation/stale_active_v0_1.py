"""Private historical stale-active checker for benchmark v0.1 reproducibility."""
...
class BenchmarkStaleActiveCheckerV1:
    """Preserve direct-link-only stale reporting for benchmark v0.1."""
